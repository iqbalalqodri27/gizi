                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="align-middle">{{$posyandu->lengkungan_kepala}}</td>
                                    <td class="align-middle">{{$posyandu->NT}}</td>
                                    <td class="align-middle">{{$posyandu->AK}}</td>
                                    <td>
                                        <a href="" class="btn btn-sm btn-info" data-toggle="modal"
                                            data-target="#modal{{$posyandu->id}}">Edit</a> | |
                                        <form class="d-inline" action="{{route('dataibu.destroy',$posyandu->id)}}" method="POST" onsubmit="return confirm('delete data ?')">
                                            @method('delete')
                                            @csrf
